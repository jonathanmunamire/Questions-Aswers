...
},
{
  ...
  Description: "To avoid making subjective decisions, we have created a list of more objective experience levels. Level 0: I have no experience coding, Level 1: I have completed some basic tutorials and courses. If you are in Level 0 or Level 1, you'll likely need a bit more practice before taking on the technical challenges in our application process. Don't worry, though; we're here to help you! You can choose to go through the Level Up Experience where you'll learn alongside other applicants, as well as, in coordinated sessions within the Level Up world. These resources provide a great introduction to HTML, CSS, JavaScript, and Git and help you pass our technical challenges. Level 2: I'm comfortable building simple algorithms and applications. Level 3: I have built and deployed applications used by real users in production. If you are in Level 2 - 3, you are already a great fit for Microverse! You should try our Admissions Coding Challenges right after signing up. Level 4: I'm a professional software developer, but I want to improve my skills. If you are in Level 4, then we still think that you could greatly benefit from our program. However, you must know that, regardless of how much experience you already have, you will still have to go through our entire full-time curriculum. Level 5: I'm a professional software developer and I just want a remote job. We are first and foremost a school and not a recruiting firm. If all you want is help to find a remote job, then we believe Microverse is not the right fit for you."
}]
